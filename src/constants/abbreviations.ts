 ...
 * Used throughout the application to display full titles for UN positions and entities
 */
export const abbreviationMap: Record<string, string> = {
  ...
  "ASG UNITAR":
    "Assistant Secretary-General for the UN Institute for Training and Research",
