...
export default function MilestonesTab({
  ...
  const [confirmDialog, setConfirmDialog] = useState<{
    ...
    status: "draft" | "approved" | "needs_attention" | "needs_ola_review" | "reviewed_by_ola" | "finalized" | "attention_to_timeline" | "confirmation_needed" | "no_submission" | null;
  ...
  const handleStatusChange = (milestoneId: string, status: "draft" | "approved" | "needs_attention" | "needs_ola_review" | "reviewed_by_ola" | "finalized" | "attention_to_timeline" | "confirmation_needed" | "no_submission") => {
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {confirmDialog.status === "no_submission" && "Mark this milestone as No Submission? This will set it to draft status."}
