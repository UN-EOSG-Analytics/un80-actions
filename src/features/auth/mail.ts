...
<tr>console.error("Mail error:", error instanceof Error ? error.message : String(error));
    <td style="padding:24px 0 0;"><p style="margin:0;font-size:12px;color:#9ca3af;">If you did not request this email, you can safely ignore it.</p></td></tr>
